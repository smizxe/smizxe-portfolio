  ...
  vi: {
    ...
    story: {
      ...
      timeline: [
        ...
        {
          year: '2024',
          title: 'Tìm được đam mê và hướng đi rõ ràng hơn',
          desc: 'Dự án thật giúp xác định rõ Yangai muốn làm gì: không chỉ code sạch, mà phải đủ sát với bài toán để biến yêu cầu thành sản phẩm thật sự dùng được.',
        },
        {
          year: '2025',
