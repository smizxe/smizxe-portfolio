  ...
  return (
    <section id="services" className="shell py-24 md:py-36">
      <Reveal>
        ...
        <h2 className="mt-5 max-w-[20ch] font-display text-[clamp(2.1rem,5vw,4rem)] font-bold leading-[1] tracking-[-0.035em] text-ink">
          {t.services.title}
        </h2>
      ...
      <ul className="mt-14 border-t border-ink/12">
        {t.services.items.map((item, i) => {
          ...
          return (
          <Reveal as="li" key={item.title} delay={i * 0.06} className="group block border-b border-ink/12">
